...
function love.conf(t)
    ...
    -- Choose between "desktop" fullscreen or "exclusive" fullscreen
    -- mode (string)
    ...
    t.modules.system = true  -- Disabling it will result 0 delta time in love.update
